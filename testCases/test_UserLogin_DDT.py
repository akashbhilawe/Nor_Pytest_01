...
class Test_Login_DDT:
    ...
    Excel_File_Path = "C:\\Users\\akash\\Downloads\\Nor_Pytest\\testCases\\Test_Data\\Test_Data.xlsx"
...
# pytest -v -n=2 -m sanity --html=HtmlReports/myreport.html --alluredir="C:\Users\akash\Downloads\Nor_Pytest\AllureReports" --browser firefox  -p no:warnings
# pytest -v -n=2 -m sanity --alluredir="C:\Users\akash\Downloads\Nor_Pytest\AllureReports" --browser firefox  -p no:warnings
# allure serve "C:\Users\akash\Downloads\Nor_Pytest\AllureReports" # To generate report
